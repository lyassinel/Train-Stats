...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "gares_select".
 */
export interface GaresSelect<T extends boolean = true> {
  garefr?: T;
  garenl?: T;
  code?: T;
  depot?: T;
